...
import {
  ...
  Edit2, Trash2, AlertTriangle, Tag, Eye, ArrowLeft, ChevronDown,
...
export default function AssetListPage() {
  ...
  const [assignedFilter, setAssignedFilter] = useState(searchParams.get('assigned_user_id') ?? '');
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <Link to="/itam" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground mb-2 transition-colors">
